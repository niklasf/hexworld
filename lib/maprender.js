define([ "coords" ], function (coords) {
    ...
    rules.push({
        ...
        "images": [
            "data/images/terrain/misc/windmill-A01.png",
            "data/images/terrain/misc/windmill-A02.png",
            "data/images/terrain/misc/windmill-A03.png",
            "data/images/terrain/misc/windmill-A04.png",
            "data/images/terrain/misc/windmill-A05.png",
            "data/images/terrain/misc/windmill-A06.png",
            "data/images/terrain/misc/windmill-A07.png",
            "data/images/terrain/misc/windmill-A08.png",
            "data/images/terrain/misc/windmill-A09.png",
            "data/images/terrain/misc/windmill-A10.png",
            "data/images/terrain/misc/windmill-A11.png",
            "data/images/terrain/misc/windmill-A12.png",
            "data/images/terrain/misc/windmill-A13.png",
            "data/images/terrain/misc/windmill-A14.png",
            "data/images/terrain/misc/windmill-A15.png",
            "data/images/terrain/misc/windmill-A16.png",
            "data/images/terrain/misc/windmill-A17.png",
            "data/images/terrain/misc/windmill-A18.png",
        ],
        "image_offset_left": -6,
        "image_offset_top": -9,
        "layer": -10
            ...
            for (var y = 0; y < height; y++) {
                ...
                for (var i = 0; i < rules.length; i++) {
                    ...
                    for (var condition in rules[i]) {
                        if (condition == "images" || condition == "probability" || condition == "layer" || condition == "image_offset_left" || condition == "image_offset_top") {
                            continue;
                        }
                    ...
                    if (rules[i].image_offset_left === undefined) {
                        rules[i].image_offset_left = 0;
                    }

                    if (rules[i].image_offset_top === undefined) {
                        rules[i].image_offset_top = 0;
                    }

                    tiles.push({
                        left: pos.left + rules[i].image_offset_left,
                        top: pos.top + rules[i].image_offset_top,
